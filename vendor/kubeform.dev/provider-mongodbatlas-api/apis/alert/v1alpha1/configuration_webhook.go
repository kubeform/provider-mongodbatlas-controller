...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-alert-mongodbatlas-kubeform-com-v1alpha1-configuration,mutating=false,failurePolicy=fail,groups=alert.mongodbatlas.kubeform.com,resources=configurations,versions=v1alpha1,name=configuration.alert.mongodbatlas.kubeform.io,sideEffects=None,admissionReviewVersions=v1
...
func (r *Configuration) ValidateUpdate(old runtime.Object) error {
	...
	for key, _ := range configurationForceNewList {
