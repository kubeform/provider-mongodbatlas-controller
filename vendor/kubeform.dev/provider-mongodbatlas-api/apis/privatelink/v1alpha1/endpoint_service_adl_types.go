...
type EndpointServiceAdl struct {
	...
	Spec              EndpointServiceAdlSpec   `json:"spec,omitempty"`
	Status            EndpointServiceAdlStatus `json:"status,omitempty"`
}

type EndpointServiceAdlSpec struct {
	State *EndpointServiceAdlSpecResource `json:"state,omitempty" tf:"-"`

	Resource EndpointServiceAdlSpecResource `json:"resource" tf:"resource"`
...
type EndpointServiceAdlSpecResource struct {
...
type EndpointServiceAdlList struct {
	...
	// Items is a list of EndpointServiceAdl CRD objects
	Items []EndpointServiceAdl `json:"items,omitempty"`
}
