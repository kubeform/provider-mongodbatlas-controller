...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-ldap-mongodbatlas-kubeform-com-v1alpha1-configuration,mutating=false,failurePolicy=fail,groups=ldap.mongodbatlas.kubeform.com,resources=configurations,versions=v1alpha1,name=configuration.ldap.mongodbatlas.kubeform.io,sideEffects=None,admissionReviewVersions=v1
