...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-cloud-mongodbatlas-kubeform-com-v1alpha1-providersnapshotrestorejob,mutating=false,failurePolicy=fail,groups=cloud.mongodbatlas.kubeform.com,resources=providersnapshotrestorejobs,versions=v1alpha1,name=providersnapshotrestorejob.cloud.mongodbatlas.kubeform.io,sideEffects=None,admissionReviewVersions=v1
...
func (r *ProviderSnapshotRestoreJob) ValidateDelete() error {
	if r.Spec.TerminationPolicy == base.TerminationPolicyDoNotTerminate {
		return fmt.Errorf(`providersnapshotrestorejob "%v/%v" can't be terminated. To delete, change spec.terminationPolicy to Delete`, r.Namespace, r.Name)
	}
	return nil
}
