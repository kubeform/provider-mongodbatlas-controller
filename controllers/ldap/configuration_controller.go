...
// +kubebuilder:rbac:groups=ldap.mongodbatlas.kubeform.com,resources=configurations,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ldap.mongodbatlas.kubeform.com,resources=configurations/status,verbs=get;update;patch
...
func (r *ConfigurationReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &ldapv1alpha1.Configuration{}); err != nil {
			klog.Error(err, "unable to set up auditor", ldapv1alpha1.Configuration{}.APIVersion, ldapv1alpha1.Configuration{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&ldapv1alpha1.Configuration{}).
...
func (r *ConfigurationReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		resourceList := &ldapv1alpha1.ConfigurationList{}
