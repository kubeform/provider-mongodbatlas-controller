...
// +kubebuilder:rbac:groups=org.mongodbatlas.kubeform.com,resources=invitations,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=org.mongodbatlas.kubeform.com,resources=invitations/status,verbs=get;update;patch
...
func (r *InvitationReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &orgv1alpha1.Invitation{}); err != nil {
			klog.Error(err, "unable to set up auditor", orgv1alpha1.Invitation{}.APIVersion, orgv1alpha1.Invitation{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&orgv1alpha1.Invitation{}).
