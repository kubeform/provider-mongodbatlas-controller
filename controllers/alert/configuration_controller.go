...
// +kubebuilder:rbac:groups=alert.mongodbatlas.kubeform.com,resources=configurations,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=alert.mongodbatlas.kubeform.com,resources=configurations/status,verbs=get;update;patch
...
func (r *ConfigurationReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &alertv1alpha1.Configuration{}); err != nil {
			klog.Error(err, "unable to set up auditor", alertv1alpha1.Configuration{}.APIVersion, alertv1alpha1.Configuration{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&alertv1alpha1.Configuration{}).
...
func (r *ConfigurationReconciler) SensitiveSecretWatch(ctx context.Context) handler.MapFunc {
	...
	return func(o client.Object) []ctrl.Request {
		...
		if !ok {
			log.Error(fmt.Errorf("expected a Secret but go a %T", o), "failed to get secret for Configuration")
			return nil
		}
		...
		resourceList := &alertv1alpha1.ConfigurationList{}
