...
// +kubebuilder:rbac:groups=maintenance.mongodbatlas.kubeform.com,resources=windows,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=maintenance.mongodbatlas.kubeform.com,resources=windows/status,verbs=get;update;patch
