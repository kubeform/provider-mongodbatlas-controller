...
// +kubebuilder:rbac:groups=cloud.mongodbatlas.kubeform.com,resources=backupschedules,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=cloud.mongodbatlas.kubeform.com,resources=backupschedules/status,verbs=get;update;patch
...
func (r *BackupScheduleReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err := r.Get(ctx, req.NamespacedName, &unstructuredObj); err != nil {
		log.Error(err, "unable to fetch BackupSchedule")
...
func (r *BackupScheduleReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &cloudv1alpha1.BackupSchedule{}); err != nil {
			klog.Error(err, "unable to set up auditor", cloudv1alpha1.BackupSchedule{}.APIVersion, cloudv1alpha1.BackupSchedule{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&cloudv1alpha1.BackupSchedule{}).
