...
// +kubebuilder:rbac:groups=online.mongodbatlas.kubeform.com,resources=archives,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=online.mongodbatlas.kubeform.com,resources=archives/status,verbs=get;update;patch
...
func (r *ArchiveReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &onlinev1alpha1.Archive{}); err != nil {
			klog.Error(err, "unable to set up auditor", onlinev1alpha1.Archive{}.APIVersion, onlinev1alpha1.Archive{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&onlinev1alpha1.Archive{}).
