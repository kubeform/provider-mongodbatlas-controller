...
// +kubebuilder:rbac:groups=advanced.mongodbatlas.kubeform.com,resources=clusters,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=advanced.mongodbatlas.kubeform.com,resources=clusters/status,verbs=get;update;patch
...
func (r *ClusterReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &advancedv1alpha1.Cluster{}); err != nil {
			klog.Error(err, "unable to set up auditor", advancedv1alpha1.Cluster{}.APIVersion, advancedv1alpha1.Cluster{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&advancedv1alpha1.Cluster{}).
