...
// +kubebuilder:rbac:groups=network.mongodbatlas.kubeform.com,resources=peerings,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=network.mongodbatlas.kubeform.com,resources=peerings/status,verbs=get;update;patch
...
func (r *PeeringReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &networkv1alpha1.Peering{}); err != nil {
			klog.Error(err, "unable to set up auditor", networkv1alpha1.Peering{}.APIVersion, networkv1alpha1.Peering{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&networkv1alpha1.Peering{}).
