...
// +kubebuilder:rbac:groups=privatelink.mongodbatlas.kubeform.com,resources=endpoints,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=privatelink.mongodbatlas.kubeform.com,resources=endpoints/status,verbs=get;update;patch
...
func (r *EndpointReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &privatelinkv1alpha1.Endpoint{}); err != nil {
			klog.Error(err, "unable to set up auditor", privatelinkv1alpha1.Endpoint{}.APIVersion, privatelinkv1alpha1.Endpoint{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&privatelinkv1alpha1.Endpoint{}).
